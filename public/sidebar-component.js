...
(function() {
  const sidebarHTML = `
    ...
    <div class="sidebar-nav">
      ...
      <a class="sidebar-item" id="nav-play" href="/play" title="온라인 대국">
      ...
      <a class="sidebar-item" id="nav-puzzle" href="/puzzle" title="퍼즐 훈련">
      ...
      <a class="sidebar-item" id="nav-explorer" href="/opening-explorer" title="오프닝 탐색기">
      ...
      <a class="sidebar-item" id="nav-records" href="/records" title="기록">
      ...
      <a class="sidebar-item" id="nav-study" href="/study" title="학습">
      ...
      <a class="sidebar-item" id="nav-practice" href="/practice" title="엔진 연습">
      ...
      <a class="sidebar-item" id="nav-stats" href="/records?tab=stats" title="통계">
