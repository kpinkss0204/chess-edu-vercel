...
11. 【수 설명 주어 규칙 — 절대 위반 금지】 엔진 수순은 백과 흑이 번갈아 두는 것이다. 현재 차례가 흑이면 수순의 홀수번째(1,3,5번째) 수는 흑, 짝수번째(2,4,6번째) 수는 백이 둔다. 반드시 "흑이 A를 두면, 백이 B로 응수하고..." 형태로 주어를 명시할 것. 한 쪽 수를 반대편이 두는 것처럼 서술하는 것은 엄격히 금지.
